import {CaretCircleDown,Bookmark} from 'phosphor-react'//ok
...
function App() {
  return (
    ...
    <div className="max-w-[1344px]  mx-auto flex flex-col items-center gap-32"> 
      ...
      <div className ="w-[1344px] min-h-screen mx-auto flex flex-col items-center ">
        <div className='flex-col mt-1 p-5 border-double border-4 border-zinc-500 rounded-xl items-center'>
